...
- clone the repo
- Add <tt>gem 'lines', path: "/path/to/gem/directory"</tt> to your Gemfile</tt>
- bundle
- Mount the engine in the routes.rb with <tt>mount Lines::Engine => "/blog"</tt>
- <tt>rake lines:install:migrationsl</tt> to copy migrations to the host ap
