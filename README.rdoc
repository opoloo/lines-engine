= A lighter copy of this repo is in {here}[https://github.com/AdoPisoWiFi/lines-engine.git].

Removed old commits which caused this repo to be heavy. Future commits will be pushed to that repo.
...
1. Add the gem to your Gemfile:
    gem 'lines-engine', git: "https://github.com/adonespitogo/lines-engine", tag: "v1.2.5"
