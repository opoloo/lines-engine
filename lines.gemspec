...
Gem::Specification.new do |s|
  ...
  s.add_dependency 'jquery-rails', '< 6', '>= 3.1.0'
  ...
  s.add_dependency 'sanitize', '>= 4.4.0'
  s.add_dependency 'sass-rails', '>= 4.0.0'
  s.add_dependency 'coffee-rails', '< 6', '>= 4.0.0'
  s.add_dependency 'uglifier', '>= 2'
  s.add_dependency 'friendly_id', '>= 5.1.0'
  s.add_dependency 'rails3-jquery-autocomplete', '>= 1.0.11'
  s.add_dependency 'meta-tags', '>= 2.0.0'
  s.add_dependency 'bcrypt-ruby', '>= 3.0.0'
  s.add_dependency 'i18n', '>= 0.7.0'
  s.add_dependency 'sprockets-rails', '< 4'
