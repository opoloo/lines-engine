...
var app,lightbox;$(document).ready(function(){return app.init()}),app={init:function(){return lightbox.init()}},lightbox={init:function(){var t;return t=$('<div class="lightbox"><img src="" alt="" /></div>'),$("body").append(t),$("[data-lightbox]").css("cursor","pointer"),this.bind_events()},bind_events:function(){return $(document).on("click","[data-lightbox]",function(t){return t.preventDefault(),lightbox.open($(this).data("lightbox"))}),$(document).on("click",".lightbox",function(t){return t.preventDefault(),$(".lightbox").fadeOut("fast")})},open:function(t){var i;return i=new Image,i.src=t,$(".lightbox img").attr("src",t),i.onload=function(){var t,i,n,o,a;return i=this.width,t=this.height,a=$(window).width(),o=$(window).height(),n=t/i*a,n>o?$(".lightbox").removeClass("landscape").addClass("portrait"):$(".lightbox").removeClass("portrait").addClass("landscape"),$(".lightbox").fadeIn("fast")}}};